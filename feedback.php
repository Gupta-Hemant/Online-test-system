...
<div class="col-lg-6">
<span class="logo">Online Skills Test</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:rgb(13, 220, 168)">Log In</span></h4>
      </div>
...
<div class="col-md-10">
<a href="mailto:hemantgupta2405@gmail.com" style="color:#000000">hemantgupta2405@gmail.com</a><br /><br />
...
<a href="https://github.com/Gupta-Hemant" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:royalblue">Developer</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Self.jpg" width=100 height=100 alt="Hemant Gupta" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.linkedin.com/in/gupta-hemant/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Linkedin" target="_blank">Hemant Gupta</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9971211451</h4>
		<h4 style="font-family:'typo' ">hemantgupta2405@gmail.com</h4>
		<h4 style="font-family:'typo' ">Insitute of Technology & Science, Ghaziabad</h4></div></div>
		</p>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:rgb(13, 220, 168);font-family:'typo' ">LOGIN</span></h4>
      </div>
